...
%
% synopsis: [mf,Pf,J,mid] = ekf_forecast(Tk,Ed,Ew,m,r,dt,dcay,P,Qphr)
%
%    ARGUMENTS
...
function [mf,Pf,J,mid] = ekf_forecast(Tk,Ed,Ew,m,r,dt,dcay,P,Qphr)

    % forecast next point
    [mf, mid] = moisture_model_ext(Tk,Ed,Ew,m,r,dt,dcay);
